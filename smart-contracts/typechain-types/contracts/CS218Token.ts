...
export interface CS218TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface CS218Token extends BaseContract {
  connect(runner?: ContractRunner | null): CS218Token;
  waitForDeployment(): Promise<this>;

  interface: CS218TokenInterface;
